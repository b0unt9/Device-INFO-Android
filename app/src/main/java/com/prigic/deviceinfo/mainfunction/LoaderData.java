...
public class LoaderData {
    ...
    public void loadBateryInfo() {
        ...
        if (isPresent) {
            ...
            s = s + "Plugged: " + BatteryUtils.getPlugTypeString(plugged) + "\n";
            s = s + "Health: " + BatteryUtils.getHealthString(health) + "\n";
            s = s + "Status: " + BatteryUtils.getStatusString(status) + "\n";
    ...
    public static ArrayList<GetInfo> getArrList(String string) {
            ...
            if (arr[i] != null && !arr[i].trim().equals("")) {
                ...
                if (arr2.length > 1 && arr2[1].trim().length() < 50) {
                    if (arr2[0].trim().toLowerCase().equals("processor")) {
                        infos.add(new GetInfo("-", "-"));
                    }
                    infos.add(new GetInfo(StrFormatter.getFormattedName(arr2[0].trim()), arr2[1].trim()));
                }
            }
