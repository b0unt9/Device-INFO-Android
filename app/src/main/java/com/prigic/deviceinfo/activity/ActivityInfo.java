...
import com.prigic.deviceinfo.mainfunction.ListItem;
import com.prigic.deviceinfo.mainfunction.SharedPref;
...
public class ActivityInfo extends Fragment {
    ...
    public void loadAndDisplayData(String title) {
        ...
        if (title.equalsIgnoreCase(getString(R.string.tab_title_cpu))) {
            ...
            listView1.setAdapter(new ListItem(getActivity(), R.layout.item_list_info, LoaderData.getArrList(s)));
